...
@section('title', 'Galeri - PANDU PORPROV')
...
<section class="page-banner">
    ...
    <div class="banner-inner">
        ...
        <div class="banner-text">
            ...
            <p>Dokumentasi lapangan selama kegiatan berlangsung</p>
        </div>
    </div>
...
<div class="galeri-page">
    ...
    <div class="gallery-grid">
        ...
        <!-- Item 2 -->
        <div class="gallery-item">
            <img src="{{ asset('images/venue1.jpeg') }}" alt="Lapangan Luar">
            <div class="overlay"></div>
            <div class="info">
        ...
        <!-- Item 5 -->
        <div class="gallery-item">
            <img src="{{ asset('images/venue2.jpeg') }}" alt="Lapangan Luar 2">
            <div class="overlay"></div>
            <div class="info">
                <p class="item-name">Lapangan Luar</p>
                <div class="item-meta">
        ...
        <!-- Item 6 -->
        <div class="gallery-item">
            <img src="{{ asset('images/venue4.jpeg') }}" alt="Lapangan Luar 2">
            <div class="overlay"></div>
            <div class="info">
                <p class="item-name">Lapangan Luar</p>
                <div class="item-meta">
