...
<div class="stats-strip">
    ...
    <div class="stats-strip-inner">
        ...
        <div class="ss-item" data-type="mall">
            <div class="ss-icon-wrap" style="background: rgba(124, 58, 237, 0.08); color: #7c3aed;">
                <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="ss-info">
                <div class="ss-num">{{ $stats['mall'] ?? 0 }}</div>
                <div class="ss-lbl">Mall</div>
            </div>
        </div>
