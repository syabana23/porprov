...
// Revert inline styles in the table header
content = content.replace(/<th colspan="1" style="text-align:center">/g, '<th colspan="1" style="background:#014590;text-align:center">');
content = content.replace(/<th colspan="20" style="text-align:center">/g, '<th colspan="20" style="background:#014590;text-align:center">');
